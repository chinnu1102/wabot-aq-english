...
// https://jalantikus.com/tips/kata-kata-Quotes/
global.Quotes = [
 ...
 "Singles. Maybe that's God's way of saying 'Rest from wrong love'.",
  ...
  "If I become the people's representative I will definitely fail, how do you want to think about the people if all I have in mind is you.",
  "Look at my garden, full of flowers. Look at your eyes, my heart is blooming.",
  "Promise to be with me now, tomorrow, and forever.",
  "Missing arises not only because of distance. But also because wishes do not come true.",
  ...
  "I know that in my every gaze, we are blocked by distance and time. But I'm sure that later we will unite.",
  ...
  "Through the longing that flares up in my heart, there sometimes I really need to hold your love hug.",
  ...
  "Do you know the difference between pensi and your face? If the writing pencil can be erased, but if your face is not there will be nothing that can be erased from my mind.",
  ...
  "You know what's the difference between going to school and going to your house? When you go to school, books and pens are definitely what you bring, but if you go to your house, I just need to bring my heart and love.
 ...
 " My homework is missing you. Stronger than Mathematics, broader than Physics, stronger than Biology. ",
  ...
  "For the sake of love we deceive ourselves. Trying to be strong in fact fell dishonorable.",
  "Think of me as your home, if you go you know where to go home. Stay if you want and go away when you are bored ...",
 ...
 "If we can only meet in a dream, I want to sleep forever.",
  ...
  "I sometimes envy an object. Have no taste but always needed. In contrast to me who has feelings, but is abandoned and neglected ...",
  ...
  "If loving you is a mistake, okay, I'll just keep on wrong.",
  "Since I know you, I want to keep learning. Learning to be the best for you.",
  ...
  "Saben Dino is crazy about dreaming but ora biso nduweni.",
  "Ora, I met 30 dino rasane koyo for a month.",
  "I am without you like a karete wild cat. Ambyar.",
  "I want to, I am wektu iso. Supoyo I am trying to make fun of it. Ben Lewih likes my time to kanggo urip with your slime.",
  ...
  "Will the moal run faded when I use Bayclean.",
  ...
  "Hayang, the rasana kuring arranges the words of love in Dunya Ieu, then I curry bade together, so that I will get bigger and feel the love of currying my soul.",
  "Calm down, wae neng, from your love, you, the song Krispatih; timeless.",
  ...
  "Just the lost network, you don't.",
  ...
  "My sleeping hours are ruined by homesickness.",
  "It is enough that China is far away, we should not love it.",
  "What's important is your happiness, I'm not important ..",
  "Only one wish, loved by you ..",
  "I am without you like an ambulance without wiuw wiuw.",
